...
public class LocationImageView_Reverse extends LinearLayout {

    public TextView text;
    public ImageView Loc, weather,best;

    public LocationImageView_Reverse(Context context) {
        super(context);
        initView();
    }
    public LocationImageView_Reverse(Context context, AttributeSet attrs) {
        super(context,attrs);
        initView();
        getAttrs(attrs);
    }
    public LocationImageView_Reverse(Context context, AttributeSet attrs, int defStyle) {
        super(context,attrs);
        initView();
    ...
    private void initView() {
        ...
        View v = li.inflate(R.layout.locationimage_reverse, this, false);
        addView(v);

        text = (TextView) findViewById(R.id.ReverseLoctext);
        Loc = (ImageView) findViewById(R.id.ReverseLocimage);
        weather = (ImageView) findViewById(R.id.Reverseweatheriamge);
        best = (ImageView)findViewById(R.id.ReverseBestView);
    }
